...
// 클래스를 통해 객체를 생성하여 접근하여 사용할 수 있는 집합체입니다.
...
#pragma region 접근 지정자
	...
	// public    :	클래스 내부에 있는 데이터를 클래스 외부와
	//				자기가 상속하고 있는 클래스에서도 접근을 허용하는 지정자입니다.

	// protected :	클래스 내부에 있는 데이터를 클래스 내부와 
	//				자기가 상속하고 있는 클래스에서만 접근을 허용하는 지정자입니다.

	// private   :	클래스 내부에 있는 데이터를
	//				클래스 내부에서만 접근을 허용하는 지정자입니다.

#pragma endregion

	int x = 5; // default : private
